...
# Increase max output tokens (default 4096 can be enough).
...
# NOTE: Do NOT set plugins.allow — it acts as a whitelist and blocks ALL built-in plugins (browser, canvas, file-transfer, memory-core, etc.) that are needed for tool execution to work.
